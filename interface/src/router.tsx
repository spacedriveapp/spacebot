...
import {AgentLearning} from "@/routes/AgentLearning";
...
const agentLearningRoute = createRoute({
	getParentRoute: () => rootRoute,
	path: "/agents/$agentId/learning",
	component: function AgentLearningPage() {
		const {agentId} = agentLearningRoute.useParams();
		return (
			<div className="flex h-full flex-col">
				<AgentHeader agentId={agentId} />
				<div className="flex-1 overflow-hidden">
					<AgentLearning agentId={agentId} />
				</div>
			</div>
		);
	},
