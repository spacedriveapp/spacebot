...
export type InstanceOverviewResponse = components["schemas"]["InstanceOverviewResponse"];
...
// Status-related
export type CancelProcessRequest = components["schemas"]["CancelProcessRequest"];
export type CancelProcessResponse = components["schemas"]["CancelProcessResponse"];

// Prompt inspection
export type PromptCaptureBody = components["schemas"]["PromptCaptureBody"];

// Archive
export type SetChannelArchiveRequest = components["schemas"]["SetChannelArchiveRequest"];
...
export type AgentOverviewResponse = components["schemas"]["AgentOverviewResponse"];
...
export type WarmupStatusResponse = components["schemas"]["WarmupStatusResponse"];
export type WarmupState = components["schemas"]["WarmupState"];
export type WarmupTriggerRequest = components["schemas"]["WarmupTriggerRequest"];
export type WarmupTriggerResponse = components["schemas"]["WarmupTriggerResponse"];
...
export type MemoriesListResponse = components["schemas"]["MemoriesListResponse"];

// Search
export type MemorySearchResult = components["schemas"]["MemorySearchResult"];
export type MemoriesSearchResponse = components["schemas"]["MemoriesSearchResponse"];
...
export type MemoryGraphNeighborsResponse = components["schemas"]["MemoryGraphNeighborsResponse"];
...
export type CortexEventsResponse = components["schemas"]["CortexEventsResponse"];

// Chat
export type CortexChatMessage = components["schemas"]["CortexChatMessage"];
export type CortexChatMessagesResponse = components["schemas"]["CortexChatMessagesResponse"];
export type CortexChatThread = components["schemas"]["CortexChatThread"];
export type CortexChatThreadsResponse = components["schemas"]["CortexChatThreadsResponse"];
export type CortexChatToolCall = components["schemas"]["CortexChatToolCall"];
export type CortexChatSendRequest = components["schemas"]["CortexChatSendRequest"];
export type CortexChatDeleteThreadRequest = components["schemas"]["CortexChatDeleteThreadRequest"];
...
export type MemoryPersistenceSection = components["schemas"]["MemoryPersistenceSection"];
...
export type MemoryPersistenceUpdate = components["schemas"]["MemoryPersistenceUpdate"];
...
// Global settings
export type GlobalSettingsResponse = components["schemas"]["GlobalSettingsResponse"];
export type GlobalSettingsUpdate = components["schemas"]["GlobalSettingsUpdate"];
export type GlobalSettingsUpdateResponse = components["schemas"]["GlobalSettingsUpdateResponse"];

// OpenCode (within global settings)
export type OpenCodeSettingsResponse = components["schemas"]["OpenCodeSettingsResponse"];
export type OpenCodeSettingsUpdate = components["schemas"]["OpenCodeSettingsUpdate"];
export type OpenCodePermissionsResponse = components["schemas"]["OpenCodePermissionsResponse"];
export type OpenCodePermissionsUpdate = components["schemas"]["OpenCodePermissionsUpdate"];

// Raw config
export type RawConfigResponse = components["schemas"]["RawConfigResponse"];
export type RawConfigUpdateRequest = components["schemas"]["RawConfigUpdateRequest"];
export type RawConfigUpdateResponse = components["schemas"]["RawConfigUpdateResponse"];
...
export type ProviderUpdateResponse = components["schemas"]["ProviderUpdateResponse"];

// Model testing
export type ProviderModelTestRequest = components["schemas"]["ProviderModelTestRequest"];
export type ProviderModelTestResponse = components["schemas"]["ProviderModelTestResponse"];

// OAuth
export type OpenAiOAuthBrowserStartRequest = components["schemas"]["OpenAiOAuthBrowserStartRequest"];
export type OpenAiOAuthBrowserStartResponse = components["schemas"]["OpenAiOAuthBrowserStartResponse"];
...
export type IngestDeleteResponse = components["schemas"]["IngestDeleteResponse"];
...
export type RegistryBrowseResponse = components["schemas"]["RegistryBrowseResponse"];
export type RegistrySearchResponse = components["schemas"]["RegistrySearchResponse"];
export type RegistrySkillContentResponse = components["schemas"]["RegistrySkillContentResponse"];
...
export type AdapterInstanceStatus = components["schemas"]["AdapterInstanceStatus"];
export type MessagingStatusResponse = components["schemas"]["MessagingStatusResponse"];
export type MessagingInstanceActionResponse = components["schemas"]["MessagingInstanceActionResponse"];

// Instances
export type CreateMessagingInstanceRequest = components["schemas"]["CreateMessagingInstanceRequest"];
export type DeleteMessagingInstanceRequest = components["schemas"]["DeleteMessagingInstanceRequest"];
...
export type BindingsListResponse = components["schemas"]["BindingsListResponse"];
export type CreateBindingRequest = components["schemas"]["CreateBindingRequest"];
export type CreateBindingResponse = components["schemas"]["CreateBindingResponse"];
export type UpdateBindingRequest = components["schemas"]["UpdateBindingRequest"];
export type UpdateBindingResponse = components["schemas"]["UpdateBindingResponse"];
export type DeleteBindingRequest = components["schemas"]["DeleteBindingRequest"];
export type DeleteBindingResponse = components["schemas"]["DeleteBindingResponse"];
export type PlatformCredentials = components["schemas"]["PlatformCredentials"];

// Toggles
export type TogglePlatformRequest = components["schemas"]["TogglePlatformRequest"];
export type DisconnectPlatformRequest = components["schemas"]["DisconnectPlatformRequest"];
...
export type WebChatHistoryMessage = components["schemas"]["WebChatHistoryMessage"];
...
export type ProjectWorktreeWithRepo = components["schemas"]["ProjectWorktreeWithRepo"];
export type ProjectWithRelations = components["schemas"]["ProjectWithRelations"];
...
export type CreateWorktreeRequest = components["schemas"]["CreateWorktreeRequest"];
...
export type DeleteSecretResponse = components["schemas"]["DeleteSecretResponse"];
