...
| **Creation** | Automatic (persistence branches, direct branch saves, cortex workflows) | Intentional (tools, API, UI) |
| **Lifecycle** | Importance decay, pruning, merging | Permanent, versioned, archivable |
| **Prompt injection** | Via knowledge context and recall | On-demand via `wiki_read` tool |
