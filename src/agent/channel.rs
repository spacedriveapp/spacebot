...
mod tests {
    use super::{
        ObserveModeFallbackState, build_spoken_generation_prompt, compute_listen_mode_invocation,
        format_identity_context, is_dm_conversation_id, load_recent_spoken_responses,
